...
4. 위 사항 리뷰 후 **T-010 (v2 완료 승인 게이트)** 진행 — 승인 시 v3(데스크톱) 논의 가능.

## User Review

- **E15 partial — 수용 (2026-08-13, 사용자):** 무효화 신호 = `/api/validate` 호출을 스펙에 인코딩 — `spec/sdv-sim-v2.md` M-4 절·`POST /api/validate` API 절·Requirements 절 3곳 반영 완료. ASR-015 Notes에 기록. (T-009 검증 U-1 해소)
